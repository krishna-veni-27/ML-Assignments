...
wine_model.add(Dense(64,activation = "relu",input_shape =(11,)))
wine_model.add(Dense(32,activation = "relu"))
wine_model.add(Dense(1))
wine_model.compile(optimizer = "adam",loss ="mse",metrics = ["mae"])
wine_model.fit(x_train,y_train,epochs = 50)
print("Training Completed......")

# Save the model & the scaler
joblib.dump(wine_model,"wine_model.pkl")
joblib.dump(scaler,"scaler.pkl")

# Evaluate the model
test_result = wine_model.predict(x_test)
